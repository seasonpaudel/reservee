                  ...
                  <div class="row">
                    ...
                    ?>
                      <div class="col-lg-3" style="min-height: 190px">
                        <p style="font-weight: bold;">Table <?php echo ++$i; ?></p>
                        <nav class="menu2">
                          ...
                          <ul>
                            ...
                            ?>
                              <li class="menu-item2">
                                <input type="checkbox" <?php echo $booked ? 'disabled' : ''; ?> name="chair[]" id="chair" value="<?php echo $r2['id']; ?>">
                              </li>
                            <?php } ?>
                          </ul>
                        </nav>
...
<?php
  ...
  // Handle the case when reservation is not set
}
?>
