    ...
    <section class="home-slider owl-carousel">
        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center text-center">
            <div class="col-md-10 col-sm-12 ftco-animate">
              <h1 class="mb-3" style= "font-family: 'Courier New', Courier, monospace;">Dine in style , book your table with smile.</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="slider-item" style="background-image: url('images/bg_2.jpg');">
        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center text-center">
            <div class="col-md-10 col-sm-12 ftco-animate">
              <h1 class="mb-3" style= "font-family: 'Courier New', Courier, monospace;">Save room for sweet delight , indulge in dessert tonight.</h1> 
            </div>
          </div>
        </div>
      </div>
