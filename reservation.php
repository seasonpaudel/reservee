...
<body>
      ...
      <div class="row">
        <div class="col-md-12 reservation pt-5 px-5">
          ...
          <div class="block-17" style="min-height: 100px;">
            <form action="restaurant-list.php" method="GET" class="d-block d-lg-flex">
  ...
  foreach ($restaurantBackgrounds as $restaurantID => $backgroundImage) {
      echo '<section class="ftco-section bg-light" style="background-image: url(\'images/' . $restaurantID . '/' . $backgroundImage . '\');">
              <div class="container">
                ...
                <div class="row d-flex">
                  <div class="col-md-4 ftco-animate img" style="background-image: url(images/' . $restaurantID . '/peony.jpg); width: 300px; height: 550px;"></div>
                    ...
                    <form action="choose-table.php" method="POST">
                      <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                          <div class="form-group">
                            <input type="hidden" name="res_id" value="' . $restaurantID . '">
