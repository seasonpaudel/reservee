   ...
   <?php include 'template/nav-bar.php'; ?>
    ...
    <section class="ftco-section bg-light" style="background-image: url('images/<?php echo $_GET['res_id']; ?>/background.jpg');">
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 ftco-animate img" style="background-image: url(images/hao.jpg); width: 300px; height: 550px;"></div>
          <div class="col-md-8 ftco-animate makereservation p-5 bg-light">
          <form action="restaurant-list.php?res_id=6" method="POST" class="d-block d-lg-flex">
